  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="hidden md:flex items-center gap-8 text-sm font-medium text-[var(--color-text-light)]">
          <button
    ...
    <main class="flex-grow">
      <header class="relative pt-32 pb-12 sm:pt-48 sm:pb-32 px-4 sm:px-6 overflow-hidden">
        <div class="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div class="hero-el flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 opacity-0 px-2 sm:px-4">
            <button
      ...
      <section class="stats-section border-y border-[var(--color-border)]/50 bg-[var(--color-surface)]/40 backdrop-blur-md relative z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div class="grid grid-cols-2 md:grid-cols-4 gap-y-4 md:gap-y-0">
            ...
            >
              ...
              <div class="text-4xl sm:text-5xl font-extralight tracking-tight text-[var(--color-text-main)] mb-2">
                <span v-if="stat.isNumber" class="gsap-counter" :data-target="stat.value">0</span>
                <span v-else>{{ stat.value }}</span>
              </div>

              <div class="flex items-center gap-1.5 text-[var(--color-text-light)] group-hover:text-[var(--color-primary)] transition-colors duration-300">
      ...
      <section ref="featuresSection" class="py-16 sm:py-24 px-4 sm:px-6 relative z-10 overflow-hidden">
        <div class="max-w-6xl mx-auto">
          <div class="step-header mb-10 sm:mb-16 text-center md:text-left border-b border-[var(--color-border)] pb-6 opacity-0">
            <h2 class="text-2xl sm:text-3xl font-semibold tracking-tight text-[var(--color-text-main)] mb-2">
              System Workflow
            </h2>
          ...
          <div class="mb-16 relative">
             <div class="step-line hidden md:block absolute top-1/2 left-10 right-10 h-0.5 bg-[var(--color-border)] -translate-y-1/2 -z-10 origin-left scale-x-0 overflow-hidden">
                <div class="data-packet absolute top-0 left-0 w-20 h-full bg-gradient-to-r from-transparent via-[var(--color-primary)] to-transparent opacity-0"></div>
            </div>

            <div class="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
              <div class="step-card w-full md:w-1/3 bg-[var(--color-surface)] p-5 sm:p-6 rounded-2xl border border-[var(--color-border)] shadow-sm flex flex-col items-center text-center relative z-10 group opacity-0 translate-y-10">
                <div class="w-12 h-12 rounded-full bg-[var(--color-green-50)] border border-[var(--color-green-100)] flex items-center justify-center mb-4 text-[var(--color-green-600)]">
                  <Icon icon="ph:plant-bold" class="w-6 h-6" />
                </div>
                <span class="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-light)] mb-1">Step 01</span>
              ...
              <div class="step-arrow text-[var(--color-border)] flex-shrink-0 z-10 bg-[var(--color-background)] p-2 rounded-full opacity-0">
              ...
              <div class="step-card w-full md:w-1/3 bg-[var(--color-primary)] p-5 sm:p-6 rounded-2xl shadow-xl flex flex-col items-center text-center relative z-10 group opacity-0 translate-y-10">
                <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mb-4 text-[var(--color-primary-text)]">
                  <Icon icon="ph:cpu-bold" class="w-6 h-6" />
                </div>
                <span class="text-[10px] font-bold uppercase tracking-widest text-[var(--color-primary-text)]/60 mb-1">Step 02</span>
              ...
              <div class="step-card w-full md:w-1/3 bg-[var(--color-surface)] p-5 sm:p-6 rounded-2xl border border-[var(--color-border)] shadow-sm flex flex-col items-center text-center relative z-10 group opacity-0 translate-y-10">
                <div class="w-12 h-12 rounded-full bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20 flex items-center justify-center mb-4 text-[var(--color-primary)]">
                  <Icon icon="ph:cloud-bold" class="w-6 h-6" />
                </div>
                <span class="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-light)] mb-1">Step 03</span>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 perspective-container">
            <div class="bento-card tilt-card md:col-span-2 p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] bg-[var(--color-surface)] border border-[var(--color-border)] group opacity-0 translate-y-8">
              <div class="flex items-start justify-between mb-6 sm:mb-8">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[var(--color-background)] border border-[var(--color-border)] flex items-center justify-center text-[var(--color-text-main)] group-hover:bg-[var(--color-primary)] group-hover:text-[var(--color-primary-text)] transition-colors duration-500 group-hover:rotate-12">
                  <Icon icon="ph:wifi-high-bold" class="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <span class="px-3 py-1 rounded-full bg-[var(--color-background)] text-[9px] sm:text-[10px] font-bold text-[var(--color-text-light)] uppercase tracking-wide group-hover:bg-[var(--color-primary)]/10 group-hover:text-[var(--color-primary)] transition-colors">Telemetry</span>
              </div>
              <h3 class="text-lg sm:text-xl font-medium text-[var(--color-text-main)] mb-3">Field Data Collection</h3>
              <p class="text-[var(--color-text-light)] text-sm leading-relaxed max-w-md">
                The ESP32 microcontroller continuously polls the <strong>DHT22</strong> and <strong>Rainfall Sensor</strong>, creating a live stream of micro-climatic conditions.
              </p>
            </div>

            <div class="bento-card tilt-card md:row-span-2 flex flex-col bg-[var(--color-surface)]/80 backdrop-blur-xl border border-purple-500/20 rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 relative overflow-hidden group opacity-0 translate-y-8">
              <div class="absolute -top-24 -right-24 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl pointer-events-none animate-pulse-slow"></div>
              <div class="flex items-center justify-between mb-6 flex-shrink-0 z-10">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-2xl bg-[var(--color-purple-200)]/30 text-[var(--color-purple-900)] flex items-center justify-center">
                    <Icon icon="ph:sparkle-fill" class="w-5 h-5" />
                  </div>
                  <div>
                    <h3 class="text-base sm:text-lg font-bold text-[var(--color-text-main)] leading-none mb-1">Gemini Analysis</h3>
                    <p class="text-[10px] font-semibold text-purple-500/80 uppercase tracking-widest">Live Inference</p>
                  </div>
                </div>
              </div>
              <div class="flex-grow overflow-y-auto space-y-6 relative z-10 custom-scrollbar pr-2 pl-1">
                 <div class="relative pl-6 border-l-2 border-[var(--color-border)] group/item">
                    <div class="absolute -left-[5px] top-1.5 w-2.5 h-2.5 rounded-full bg-[var(--color-surface)] border-2 border-[var(--color-border)] group-hover/item:border-[var(--color-green-600)] transition-colors"></div>
                    <h4 class="text-xs font-bold text-[var(--color-text-main)] mb-1">Crop Health</h4>
                    <p class="text-xs text-[var(--color-text-light)]">Conditions optimal. Maintain water levels.</p>
                 </div>
                 <div class="relative pl-6 border-l-2 border-[var(--color-border)] group/item">
                    <div class="absolute -left-[5px] top-1.5 w-2.5 h-2.5 rounded-full bg-[var(--color-surface)] border-2 border-[var(--color-border)] group-hover/item:border-orange-500 transition-colors"></div>
                    <h4 class="text-xs font-bold text-[var(--color-text-main)] mb-1">Pest Alert</h4>
                    <p class="text-xs text-[var(--color-text-light)]">Humidity 76%. Watch for Rice Blast.</p>
                 </div>
              </div>
            </div>

            <div class="bento-card tilt-card p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] bg-[var(--color-surface)] border border-[var(--color-border)] group opacity-0 translate-y-8">
              <div class="mb-4 text-[var(--color-text-main)] group-hover:scale-110 group-hover:rotate-12 transition-transform duration-500">
                <Icon icon="ph:bell-ringing-bold" class="w-7 h-7 sm:w-8 sm:h-8" />
              </div>
              <h3 class="text-base sm:text-lg font-medium text-[var(--color-text-main)] mb-2">Smart Alerts</h3>
              <p class="text-[var(--color-text-light)] text-xs leading-relaxed">Immediate SMS notifications to farmers when thresholds are breached.</p>
            </div>
             ...
             <div class="bento-card tilt-card p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] bg-[var(--color-surface)] border border-[var(--color-border)] group opacity-0 translate-y-8">
              ...
              <h3 class="text-base sm:text-lg font-medium text-[var(--color-text-main)] mb-2">Realtime DB</h3>
              <p class="text-[var(--color-text-light)] text-xs leading-relaxed">Low latency data storage ensuring history is always available &lt;100ms.</p>
            </div>
          </div>
        </div>
      </section>

      <section ref="hardwareSection" class="hardware-section py-16 sm:py-24 bg-[var(--color-surface)] px-4 sm:px-6 border-t border-[var(--color-border)] relative z-10">
        <div class="max-w-5xl mx-auto">
          <div class="hardware-header text-center mb-10 sm:mb-16 opacity-0">
            <h2 class="text-2xl sm:text-3xl font-semibold text-[var(--color-text-main)] mb-3">Hardware Specs</h2>
            <div class="w-12 h-1 bg-[var(--color-primary)] mx-auto rounded-full"></div>
            <p class="text-sm text-[var(--color-text-light)] mt-4">Industrial-grade functionality, accessible components.</p>
          </div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-8 mt-8 sm:mt-12">
            ...
            >
              <div class="hardware-icon w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-[var(--color-primary)] group-hover:text-[var(--color-primary-text)] transition-all duration-300">
                <Icon :icon="item.icon" class="w-6 h-6 sm:w-7 sm:h-7 text-[var(--color-text-light)] group-hover:text-[var(--color-primary-text)] transition-colors" />
              </div>
              <h3 class="font-bold text-xs sm:text-sm text-[var(--color-text-main)] mb-1">{{ item.name }}</h3>
              <p class="text-[9px] sm:text-[10px] text-[var(--color-text-light)] uppercase tracking-wide">{{ item.desc }}</p>
            </div>
          </div>
        </div>
      </section>

      <section class="cta-section py-16 sm:py-32 px-4 sm:px-6 bg-[var(--color-surface)] border-t border-[var(--color-border)] relative overflow-hidden">
        <div class="max-w-3xl mx-auto text-center relative z-10 opacity-0 scale-95 cta-container">
          <h2 class="text-3xl sm:text-5xl font-semibold tracking-tight mb-4 sm:mb-6 text-[var(--color-text-main)]">Deploy today.</h2>
          <p class="text-[var(--color-text-light)] mb-8 sm:mb-10 text-base sm:text-lg font-light">Join the agricultural modernization initiative.</p>
          <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto">
            <button @click="$router.push({ name: 'signup' })" class="w-full sm:w-auto min-w-[160px] px-8 py-3.5 sm:py-4 bg-[var(--color-primary)] text-[var(--color-primary-text)] rounded-full font-bold hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-[var(--color-primary)]/40 hover:-translate-y-1">Create Account</button>
          </div>
        </div>
      </section>
    </main>

    <footer class="bg-[var(--color-surface)] border-t border-[var(--color-border)] py-10 px-6 relative z-10">
      <div class="max-w-6xl mx-auto text-center">
        <p class="text-[var(--color-text-light)] text-sm font-medium">&copy; {{ currentYear }} Climate Monitoring. All Rights Reserved.</p>
      </div>
    </footer>
  </div>
</template>
...
onMounted(() => {
  ...
  ctx = gsap.context(() => {
    ...
    heroTl.to('.hero-el', { y: 0, opacity: 1, duration: 1.2, stagger: 0.1 })
    ...
    flowTl.to('.step-header', { opacity: 1, duration: 0.8 })
          .to('.step-line', { scaleX: 1, duration: 1, ease: 'power2.inOut' }, '-=0.4')
          .to('.step-card, .step-arrow', {
...
/* GSAP Init states */
.hero-el, .stat-item, .bento-card, .step-card, .hardware-card, .step-arrow {
